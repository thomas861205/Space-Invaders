...
#display only one ssd
set_property PACKAGE_PIN W4 [get_ports {four[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {four[3]}]

set_property PACKAGE_PIN V4 [get_ports {four[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {four[2]}]

set_property PACKAGE_PIN U4 [get_ports {four[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {four[1]}]

set_property PACKAGE_PIN U2 [get_ports {four[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {four[0]}]